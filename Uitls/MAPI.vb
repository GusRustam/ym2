...
Public Class MAPI
    ...
    Private Function SendMail(ByVal strSubject As String,
        ...
        _mLastError = MAPISendMail(New IntPtr(0), New IntPtr(0), msg, how,
                                   0)
        If _mLastError > 1 Then
    ...
    Private Function GetAttachments(ByRef fileCount As Integer) As IntPtr
        fileCount = 0
        If _mAttachments Is Nothing Then
            Return 0
        End If

        If (_mAttachments.Count <= 0) Or (_mAttachments.Count >
                                          maxAttachments) Then
            Return 0
        End If
        ...
        For Each strAttachment In _mAttachments
    ...
    Public Function GetLastError() As String
        If _mLastError <= 26 Then
            Return errors(_mLastError)
        End If
        Return "MAPI error [" + _mLastError.ToString() + "]"
    End Function
    ...
    ReadOnly _mRecipients As New List(Of MapiRecipDesc)
    ReadOnly _mAttachments As New List(Of String)
    Dim _mLastError As Integer = 0
