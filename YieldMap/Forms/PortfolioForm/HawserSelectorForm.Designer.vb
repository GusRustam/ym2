...
Partial Class HawserSelectorForm
    ...
    Private Sub InitializeComponent()
        ...
        'ChainListBox
        '
        Me.ChainListBox.DataSource = Me.HawserBindingSource
        Me.ChainListBox.DisplayMember = "hawser_name"
        ...
        Me.Label1.Text = "Select one or more lists"
        '
        'IncludeCB
        '
        ...
        Me.Name = "HawserSelectorForm"
        Me.Text = "Select user-defined list"
