...
Namespace Curves
    Public Interface ICurve
        ...
        Event Updated As Action(Of ICurve, List(Of YieldDuration), Double)
    End Interface
...
#Region "Events"
        Public Event Updated As Action(Of ICurve, List(Of YieldDuration), Double) Implements ICurve.Updated
...
#Region "Internals"
        ...
        Public Overridable Function GetCurveData() As List(Of YieldDuration)
            Return CurveData
        End Function
